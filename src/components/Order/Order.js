...
export default function Order(props){
    ...
    return (
        <div className={"w-[100svw] h-[93svh] md:w-[82svw] md:h-[93svh] md:border-l-2 border-t-2 dark:text-white flex flex-col items-center justify-center space-y-4 select-none"}>
            ...
            <div className={"flex space-x-4"}>
                <button className={"text-2xl px-4 py-2 cursor-pointer rounded-full border-2 dark:border-white bg-green-800 border-black md:hover:bg-green-900"}>Buy</button>
                <button className={"text-2xl px-4 py-2 cursor-pointer rounded-full border-2 dark:border-white bg-red-600 border-black md:hover:bg-red-700"}>Sell</button>
            </div>
        </div>
    )
}