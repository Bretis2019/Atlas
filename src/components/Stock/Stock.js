    ...
    return(
        <div className={"dark:bg-black dark:divide-white dark:text-white w-[100svw] md:w-[82svw] md:h-[93svh] grid grid-cols-1 md:grid-cols-2 grid-rows-6 divide-x-2 divide-y-2 divide-black border-r-2 md:border-r-0"}>
            <div className="flex flex-col border-t-2 dark:border-white border-black border-l-2 row-span-3">
                <div className={"flex justify-between max-h-[35px] cursor-pointer px-2"}>
                    <svg onClick={() => props.onPageChange("Order")} width="30px" height="30px" viewBox="0 0 24 24" className={"mt-1 fill-black dark:fill-white"} xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"> <g id="shop-cart"> <g> <circle cx={9} cy={21} r={2} /> </g> <g> <circle cx={19} cy={21} r={2} /> </g> <g> <path d="M21,18H7.2l-4-16H0V0h4.8l0.8,3H24l-3.2,11H8.3l0.5,2H21V18z M7.8,12h11.5l2-7H6L7.8,12z" /> </g> </g> </g></svg>
                    {favorite ?
